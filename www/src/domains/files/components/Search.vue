...
import { search } from "@/domains/files/api";
...
const text = computed(() => {
  ...
  // When empty, show type hint plus Esc-to-exit hint; otherwise show press-to-search
  return prompt.value === ""
    ? `${t("search.typeToSearch")} ${t("search.pressEsc")}`
