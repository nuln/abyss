    ...
    <header-bar v-if="isPdf || isEpub || isCsv || showNav">
      ...
      <template #actions>
        ...
        <action
          ...
          show="info"
        />
        <ActionSlot name="file-preview-menu" />
      </template>
    </header-bar>
...
import { files as api, createURL } from "@/domains/files/api";
import { resizePreview } from "@/shared/utils/constants";
import url from "@/shared/utils/url";
import { throttle } from "lodash-es";
import HeaderBar from "@/shared/ui/header/HeaderBar.vue";
import Action from "@/shared/ui/header/Action.vue";
import ExtendedImage from "@/domains/files/components/files/ExtendedImage.vue";
import VideoPlayer from "@/domains/files/components/files/VideoPlayer.vue";
import CsvViewer from "@/domains/files/components/files/CsvViewer.vue";
